            ...
            if (parameterAnnotations != null) {
                for (Annotation parameterAnnotation : parameterAnnotations) {
                    ...
                    if (parameterAnnotation instanceof Url) {
                        ...
                        gotBody = true;
                      // todo this is additional
                    } else if (parameterAnnotation instanceof QueryBean) {
                        QueryBean queryObj = (QueryBean) parameterAnnotation;
                        Class<?> rawParameterType = Types.getRawType(parameterType);
                        action = RetrofitHack.getRequestAction(method,retrofit, i, parameterType, parameterAnnotations, rawParameterType);
                    }
